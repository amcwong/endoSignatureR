...
The following packages are used in the package but citations are listed here for reference (to be formatted manually):

- **readr** (Wickham et al., 2024): For reading TSV/CSV files
- **scales** (Wickham & Seidel, 2024): For plot scaling and formatting
- **limma** (Ritchie et al., 2015): For differential expression analysis
- **circlize** (Gu et al., 2014): For circular visualization
- **rsample** (Kuhn & Silge, 2024): For cross-validation splits
- **jsonlite** (Ooms, 2014): For JSON export/import
- **knitr** (Xie, 2024): For vignette generation
- **rmarkdown** (Allaire et al., 2024): For R Markdown processing
- **testthat** (Wickham, 2024): For unit testing
