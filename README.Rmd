...
Generative AI tools (e.g., GitHub Copilot, ChatGPT) were used for brainstorming, code completions, debugging, and drafting where noted; all outputs were reviewed and validated by the author. Notably, GitHub Copilot was used extensively throughout creating the test suite and ChatGPT was used for commenting and proofreading.
