...
6. **MA Plot**: Visualize fold change vs mean expression
7. **Volcano Plot**: Visualize significance vs biological effect
8. **Gene Selection**: Select top genes by variance, DE, or custom criteria
9. **Heatmap Visualization**: Create publication-quality heatmaps with phenotype annotations
