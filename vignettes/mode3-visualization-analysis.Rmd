...
vignette: >
  %\VignetteIndexEntry{Exploring and Visualizing Endometrial Data}
...
Mode 3 can work with labeled or unlabeled data. Load your data files using `esr_loadFromFiles()`:

```{r mode3-data-loading, eval=FALSE}
# Option 1: Load labeled data (for group-based analysis)
user_data <- esr_loadFromFiles(
  counts_file = "my_counts.tsv",
  pheno_file = "my_metadata.tsv",  # Optional: for group-based analysis
...
# Option 2: Load unlabeled data (for general QC)
...
- Differential expression: @limma2015 for differential expression analyses for RNA-sequencing studies
- Visualization: @ggplot22016 for elegant graphics and @complexheatmap2016 for complex heatmap visualizations
